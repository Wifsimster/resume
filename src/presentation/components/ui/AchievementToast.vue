...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-0.5">
      ...
      <span class="font-(--font-display) text-2xl sm:text-xl font-bold text-(--color-paper-cream)">{{ t(`achievements.${achievement.id}.name`) }}</span>
