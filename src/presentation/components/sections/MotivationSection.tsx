...
export default function MotivationSection() {
  ...
  return (
    <section id="motivation" className="section bg-transparent section-padding" data-section="motivation">
      {/* Content */}
      <div className="section-content flex flex-col justify-center items-center h-full">
        <div className="section-header w-full reveal">
          <h2 className="text-[var(--color-terminal-green)] mb-2">{t('motivation.title')}</h2>
          <p className="section-subtitle">{t('motivation.subtitle')}</p>
        </div>

        <div className="flex flex-col gap-4 w-full max-w-[800px] xl:max-w-[1000px] 2xl:max-w-[1200px]">
          {/* Ideal Environment */}
